...
(function () {
    ...
    if (R.svg) {
        ...
        theImage = function (svg, src, x, y, w, h,id) {
            var el = $("image");
            $(el, {x: x, y: y, width: w , height: h, preserveAspectRatio: "none",bla:"horst"});
            el.setAttributeNS(svg.xlink, "href", src);


            //var title= createNode("title");
            /*
            el.title = "hallo";
            el.string = "Hallo";
            el.text = "Hallo";
...
*/
            //el[appendChild](theText(svg,0,0,"Hallo"));
        ...
        theText = function (svg, x, y, text, id) {
            var el = $("text");
    ...
    elproto.drag = function (onmove, onstart, onend, move_scope, start_scope, end_scope,onclick) {
        this._drag = {};
    ...
    paperproto.image = function (src, x, y, w, h,id) {
        return theImage(this, src || "about:blank", x || 0, y || 0, w || 0, h || 0, id || 0);
    };
    paperproto.text = function (x, y, text, id) {
        return theText(this, x || 0, y || 0, Str(text), id || 0);
    };
